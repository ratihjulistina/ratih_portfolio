...
function Skills() {
  return (
    <div
      id="Skills"
      className="bg-[rgb(49,51,59)] h-max border-x-2  border-[#ffc96b] pb-20 mobile:pt-10"
    >
      {/* <img
      ...
      <div>
        <div className="flex flex-col justify-center items-center text-[#f8f7f6] w-[80%] m-auto gap-5">
          ...
          <div className="w-[100%] h-[100%] grid grid-cols-4 gap-10 justify-center items-center pt-10 m-auto mobile:grid-cols-2">
            <SkillItem icon="html" />
            <SkillItem icon="css" />
